  ...
  if not _ctx.executing_eagerly():
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._handle, _ctx.device_name, "TRTCalibOp", name,
        _ctx._post_execution_callbacks, in_tensor, "segment_nodes",
...
def trt_calib_op_eager_fallback(in_tensor, segment_nodes, segment_output_names, input_names, resource_name, name=None):
...
def trt_engine_op(in_tensor, serialized_engine, input_nodes, output_nodes, OutT, name=None):
  ...
  if not _ctx.executing_eagerly():
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._handle, _ctx.device_name, "TRTEngineOp", name,
        _ctx._post_execution_callbacks, in_tensor, "serialized_engine",
...
def trt_engine_op_eager_fallback(in_tensor, serialized_engine, input_nodes, output_nodes, OutT, name=None):
  r"""This is the slowpath function for Eager mode.
